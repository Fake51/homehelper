...
const weatherRequest = callback => {
  const request = new Request(
    `https://api.openweathermap.org/data/2.5/onecall?lat=${weatherConfig.latitude}&lon=${weatherConfig.longitude}&appid=${weatherConfig.apiKey}&units=${weatherConfig.units}`
  );
